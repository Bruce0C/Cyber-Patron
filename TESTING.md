...
| --- | --- | --- | --- | --- |
| bag | [bag-total.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/templates/bag/bag-total.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-bag-total.png) | ⚠️ Notes (if applicable) |
| bag | [bag.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/templates/bag/bag.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-bag.png) | ⚠️ Notes (if applicable) |
| bag | [checkout-buttons.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/templates/bag/checkout-buttons.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-checkout-buttons.png) | ⚠️ Notes (if applicable) |
| bag | [product-image.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/templates/bag/product-image.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-product-image.png) | ⚠️ Notes (if applicable) |
| bag | [product-info.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/templates/bag/product-info.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-product-info.png) | ⚠️ Notes (if applicable) |
| bag | [quantity-form.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/templates/bag/quantity-form.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-quantity-form.png) | ⚠️ Notes (if applicable) |
| checkout | [checkout.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/templates/checkout/checkout.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-checkout-checkout.png) | ⚠️ Notes (if applicable) |
| checkout | [checkout_success.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/templates/checkout/checkout_success.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-checkout-checkout_success.png) | ⚠️ Notes (if applicable) |
| home | [index.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/home/templates/home/index.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-home-index.png) | ⚠️ Notes (if applicable) |
| products | [add_product.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/templates/products/add_product.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-products-add_product.png) | ⚠️ Notes (if applicable) |
| products | [edit_product.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/templates/products/edit_product.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-products-edit_product.png) | ⚠️ Notes (if applicable) |
| products | [product_detail.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/templates/products/product_detail.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-products-product_detail.png) | ⚠️ Notes (if applicable) |
| products | [products.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/templates/products/products.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-products-products.png) | ⚠️ Notes (if applicable) |
| profiles | [profile.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/profiles/templates/profiles/profile.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-profiles-profile.png) | ⚠️ Notes (if applicable) |
| templates | [404.html](https://github.com/Bruce0C/Cyber-Patron/blob/main/templates/errors/404.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-404.png) | ⚠️ Notes (if applicable) |
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| bag | [admin.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/bag/admin.py) | ![screenshot](documentation/validation/py-bag-admin.png) | ⚠️ Notes (if applicable) |
| bag | [contexts.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/contexts.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/bag/contexts.py) | ![screenshot](documentation/validation/py-bag-contexts.png) | ⚠️ Notes (if applicable) |
| bag | [models.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/bag/models.py) | ![screenshot](documentation/validation/py-bag-models.png) | ⚠️ Notes (if applicable) |
| bag | [bag_tools.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/templatetags/bag_tools.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/bag/templatetags/bag_tools.py) | ![screenshot](documentation/validation/py-bag-bag_tools.png) | ⚠️ Notes (if applicable) |
| bag | [tests.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/bag/tests.py) | ![screenshot](documentation/validation/py-bag-tests.png) | ⚠️ Notes (if applicable) |
| bag | [urls.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/bag/urls.py) | ![screenshot](documentation/validation/py-bag-urls.png) | ⚠️ Notes (if applicable) |
| bag | [views.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/bag/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/bag/views.py) | ![screenshot](documentation/validation/py-bag-views.png) | ⚠️ Notes (if applicable) |
| checkout | [admin.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/admin.py) | ![screenshot](documentation/validation/py-checkout-admin.png) | ⚠️ Notes (if applicable) |
| checkout | [forms.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/forms.py) | ![screenshot](documentation/validation/py-checkout-forms.png) | ⚠️ Notes (if applicable) |
| checkout | [models.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/models.py) | ![screenshot](documentation/validation/py-checkout-models.png) | ⚠️ Notes (if applicable) |
| checkout | [signals.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/signals.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/signals.py) | ![screenshot](documentation/validation/py-checkout-signals.png) | ⚠️ Notes (if applicable) |
| checkout | [tests.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/tests.py) | ![screenshot](documentation/validation/py-checkout-tests.png) | ⚠️ Notes (if applicable) |
| checkout | [urls.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/urls.py) | ![screenshot](documentation/validation/py-checkout-urls.png) | ⚠️ Notes (if applicable) |
| checkout | [views.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/views.py) | ![screenshot](documentation/validation/py-checkout-views.png) | ⚠️ Notes (if applicable) |
| checkout | [webhook_handler.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/webhook_handler.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/webhook_handler.py) | ![screenshot](documentation/validation/py-checkout-webhook_handler.png) | ⚠️ Notes (if applicable) |
| checkout | [webhooks.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/checkout/webhooks.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/checkout/webhooks.py) | ![screenshot](documentation/validation/py-checkout-webhooks.png) | ⚠️ Notes (if applicable) |
|  | [custom_storages.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/custom_storages.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/custom_storages.py) | ![screenshot](documentation/validation/py--custom_storages.png) | ⚠️ Notes (if applicable) |
| cyber_patron | [settings.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/cyber_patron/settings.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/cyber_patron/settings.py) | ![screenshot](documentation/validation/py-cyber_patron-settings.png) | ⚠️ Notes (if applicable) |
| cyber_patron | [urls.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/cyber_patron/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/cyber_patron/urls.py) | ![screenshot](documentation/validation/py-cyber_patron-urls.png) | ⚠️ Notes (if applicable) |
| cyber_patron | [views.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/cyber_patron/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/cyber_patron/views.py) | ![screenshot](documentation/validation/py-cyber_patron-views.png) | ⚠️ Notes (if applicable) |
| home | [admin.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/home/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/home/admin.py) | ![screenshot](documentation/validation/py-home-admin.png) | ⚠️ Notes (if applicable) |
| home | [models.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/home/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/home/models.py) | ![screenshot](documentation/validation/py-home-models.png) | ⚠️ Notes (if applicable) |
| home | [tests.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/home/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/home/tests.py) | ![screenshot](documentation/validation/py-home-tests.png) | ⚠️ Notes (if applicable) |
| home | [urls.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/home/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/home/urls.py) | ![screenshot](documentation/validation/py-home-urls.png) | ⚠️ Notes (if applicable) |
| home | [views.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/home/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/home/views.py) | ![screenshot](documentation/validation/py-home-views.png) | ⚠️ Notes (if applicable) |
|  | [manage.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/manage.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/manage.py) | ![screenshot](documentation/validation/py--manage.png) | ⚠️ Notes (if applicable) |
| products | [admin.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/products/admin.py) | ![screenshot](documentation/validation/py-products-admin.png) | ⚠️ Notes (if applicable) |
| products | [forms.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/products/forms.py) | ![screenshot](documentation/validation/py-products-forms.png) | ⚠️ Notes (if applicable) |
| products | [models.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/products/models.py) | ![screenshot](documentation/validation/py-products-models.png) | ⚠️ Notes (if applicable) |
| products | [tests.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/products/tests.py) | ![screenshot](documentation/validation/py-products-tests.png) | ⚠️ Notes (if applicable) |
| products | [urls.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/products/urls.py) | ![screenshot](documentation/validation/py-products-urls.png) | ⚠️ Notes (if applicable) |
| products | [views.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/products/views.py) | ![screenshot](documentation/validation/py-products-views.png) | ⚠️ Notes (if applicable) |
| products | [widgets.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/products/widgets.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/products/widgets.py) | ![screenshot](documentation/validation/py-products-widgets.png) | ⚠️ Notes (if applicable) |
| profiles | [admin.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/profiles/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/profiles/admin.py) | ![screenshot](documentation/validation/py-profiles-admin.png) | ⚠️ Notes (if applicable) |
| profiles | [forms.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/profiles/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/profiles/forms.py) | ![screenshot](documentation/validation/py-profiles-forms.png) | ⚠️ Notes (if applicable) |
| profiles | [models.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/profiles/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/profiles/models.py) | ![screenshot](documentation/validation/py-profiles-models.png) | ⚠️ Notes (if applicable) |
| profiles | [tests.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/profiles/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/profiles/tests.py) | ![screenshot](documentation/validation/py-profiles-tests.png) | ⚠️ Notes (if applicable) |
| profiles | [urls.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/profiles/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/profiles/urls.py) | ![screenshot](documentation/validation/py-profiles-urls.png) | ⚠️ Notes (if applicable) |
| profiles | [views.py](https://github.com/Bruce0C/Cyber-Patron/blob/main/profiles/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Bruce0C/Cyber-Patron/main/profiles/views.py) | ![screenshot](documentation/validation/py-profiles-views.png) | ⚠️ Notes (if applicable) |
...
[![GitHub issue custom search](https://img.shields.io/github/issues-search/Bruce0C/Cyber-Patron?query=is%3Aissue%20is%3Aclosed%20label%3Abug&label=Fixed%20Bugs&color=green)](https://www.github.com/Bruce0C/Cyber-Patron/issues?q=is%3Aissue+is%3Aclosed+label%3Abug)

I've used [GitHub Issues](https://www.github.com/Bruce0C/Cyber-Patron/issues) to track and manage bugs and issues during the development stages of my project.

All previously closed/fixed bugs can be tracked [here](https://www.github.com/Bruce0C/Cyber-Patron/issues?q=is%3Aissue+is%3Aclosed+label%3Abug).
...
| Static files are not loading correctly. Thereby resulting in the user not being able to view thier items |     |
